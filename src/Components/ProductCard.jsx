...
import products from '../utils/products'; // Ensure this is the path to your product data
...
const ProductCard = () => {
  ...
  if (!product) {
    return <div className="text-white text-center p-10">Product not found</div>; // Handle case where product is not found
  }
