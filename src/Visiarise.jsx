...
const Visiarise = () => {
  ...
  return (
    <div
      ...
      style={{ height: '85vh' }} // Manually set the height to 85% of the viewport
    ...
    >
      ...
      <div className="absolute inset-x-0 bottom-0 h-1/4 bg-gradient-to-t from-blue-500 via-blue-700 to-transparent opacity-80 z-10" />

      <h2 className="text-center text-3xl md:text-4xl font-bold mb-4 z-20">
